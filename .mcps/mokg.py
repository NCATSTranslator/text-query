...
def NODE_path(source_id: Any, target_id: Any, limit: int = 3) -> str:
  ...
  Args:
    source_id: Internal node ID (int) obtained from is_NODE - must be exact internal_id value
    target_id: Internal node ID (int) obtained from is_NODE - must be exact internal_id value
